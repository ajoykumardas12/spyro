        ...
        <div className="relative w-full">
            ...
            <div className="absolute top-0 left-0 w-full h-full flex items-center p-16 bg-gradient-to-t from-black/20 to-black/20">
                <div className="w-[55%] flex flex-col gap-6 mt-20">
                    ...
                    <p className="text-lg leading-7 tracking-wide">Get ready to sweat it out and achieve your fitness goals with our high-energy fitness classes! Our classes are designed to cater to all fitness levels and provide a fun and motivating environment to help you reach your peak performance.</p>
                    <button className="w-40 bg-brand">
                        Start free trial
                    </button>
                </div>
            </div>
