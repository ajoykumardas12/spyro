...
function Hero() {
    return (
        <div className="relative w-full">
            ...
            />
            <div 
                className="absolute z-20 top-0 left-0 w-full h-full flex items-center px-10 xs:px-16 sm:px-16 lg:px-24 py-16 bg-gradient-to-t from-black/20 to-black/20"
            >
                <div 
                    className="w-full md:w-11/12 lg:w-[55%] flex flex-col gap-3 md:gap-4 lg:gap-6 mt-28 sm:mt-20"
                >
                    <h1 
                    ...
                    <p 
                        className="text-[1rem] lg:text-[1.12rem] leading-5 xs:leading-6 lg:leading-7 tracking-wide text-white/75 mb-3"
                    >
